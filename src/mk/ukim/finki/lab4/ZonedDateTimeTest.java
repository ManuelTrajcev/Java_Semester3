...
public class ZonedDateTimeTest {
    ...
    static ZonedDateTime zonedDateTimeOf() {
        ...
        ZonedDateTime zdt = ZonedDateTime.of(2015, 7, 10, 2, 14, 25, 0, zoneId);
        return zdt;
    }
    ...
    static ZonedDateTime zonedDateTimeParse() {
         ...
         */
        ZoneId zoneId = ZoneId.of("Asia/Tokyo");
        ZonedDateTime zdt = ZonedDateTime.parse("2015-06-18T23:07:25.000+09:00");
    ...
    static ZonedDateTime sameLocalAs() {
         ...
         */
        ZoneId zoneId = ZoneId.of("America/Los_Angeles");
        return zdt.withZoneSameLocal(zoneId);
    }
