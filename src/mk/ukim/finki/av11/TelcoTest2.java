...
class TelcoApp {
    ...
    public void addCall(String uuid, String dialer, String receiver, long timestampCalled) {
        Call c = new Call(uuid, dialer, receiver, timestampCalled);
    ...
    public void printChronologicalReport(String phoneNumber) {
        ...
        calls.forEach(call -> {
            if (call.dialer.equals(phoneNumber)) {
                if (call.callStarted == call.callEnded) {
                    System.out.println(String.format("D %s MISSED CALL %s", call.receiver, DurationConverter.convert(call.totalTime())));
                } else
                ...
                if (call.callStarted == call.callEnded) {
                    ...
                    System.out.println(String.format("R %s %d %d %s", call.receiver, call.callStarted, call.callEnded, DurationConverter.convert(call.totalTime())));
            }
        });
    }
}
