...
public class BinarySearchTree<E extends Comparable<E>> {
    ...
    public int maxPathSumR(BNode<Integer> node, Res res) {
        if (node == null) {
            return 0;
        }
        ...
        int ls = maxPathSumR(node.left, res);
        int rs = maxPathSumR(node.right, res);
    ...
    public int maxPathSum(BNode<Integer> node) {
        Res res = new Res();
        res.val = Integer.MIN_VALUE;
        maxPathSumR(node, res);
        return res.val;
    }
