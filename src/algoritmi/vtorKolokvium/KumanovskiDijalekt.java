...
//
//        CBHT<String, String> translate = new CBHT<>(2 * N);
//
//        String[] rechnik = new String[N];
//
//        for (int i = 0; i < N; i++) {
//            rechnik[i] = br.readLine();
//            String[] zborovi = rechnik[i].split("\\s+");
//            translate.insert(zborovi[0], zborovi[1]);
//        }
//
...
//            String word = wordsFromText[i];
//            String sign = "";
//            String translatedWord;
//
//            if (!Character.isAlphabetic(wordsFromText[i].charAt(wordsFromText[i].length() - 1))) {
//                sign = String.valueOf(wordsFromText[i].charAt(wordsFromText[i].length() - 1));
//            }
//
//            word = cleanString(word);
//            if (translate.search(word) == null) {
//                translatedWord = word;
//            } else {
//                translatedWord = translate.search(word).element.value;
//            }
//
//            if (Character.isUpperCase(wordsFromText[i].charAt(0))) {
