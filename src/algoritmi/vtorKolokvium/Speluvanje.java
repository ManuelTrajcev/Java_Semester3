...
//        }
//
//        String[] wordsInSentence = br.readLine().split("\\s+");
//        boolean bravo = true;
//
//        for (int i = 0; i < wordsInSentence.length; i++) {
//            if (wordsInSentence.length == 1 && wordsInSentence[0].length() == 1) {
//                break;
//            }
//            String curr = wordsInSentence[i].toLowerCase();
//            if (curr.charAt(curr.length() - 1) == '.' || curr.charAt(curr.length() - 1) == ',' || curr.charAt(curr.length() - 1) == '?' || curr.charAt(curr.length() - 1) == '!') {
//                curr = curr.substring(0, curr.length() - 1);
//            }
//
//            if (tabela.search(new Zbor(curr)) == -1) {
