...
//        List<String> list = new ArrayList<>(List.of(sc.nextLine().split("\\s+")));
//
...
//
//        Map<String, Integer> paths = graph.shortestPath(parts[0]);
//        paths
//                .entrySet()
//                .stream()
//                .filter(i -> i.getValue() <= maxDistance && !i.getKey().equals(parts[0]))
